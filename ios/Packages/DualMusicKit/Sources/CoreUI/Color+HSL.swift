...
public extension Color {
    ...
    /// et avec `Color.hsl(...)` de Compose utilisé côté Android.
    ///
    /// - Parameters:
    ...
    /// Construit une `Color` depuis un entier hexadécimal `0xRRGGBB`.
    ///
    /// Réservé aux **quelques** couleurs de chrome reprises telles quelles d'Android
    /// (dégradés de barres). Pour tout le reste, utiliser les jetons de ``DMColors``.
    ///
    /// - Parameters:
    ///   - hex: valeur `0xRRGGBB`.
    ///   - alpha: opacité (0–1).
