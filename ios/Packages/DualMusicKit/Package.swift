...
let package = Package(
    ...
    targets: [
        ...
        .target(name: "FeatureFeed", dependencies: ["CoreNetwork", "CoreUI", "CoreLiveMedia", "CoreRealtime", "DomainModels", "FeatureLive"]),
        ...
        .target(name: "FeatureConcert", dependencies: ["CoreNetwork", "CoreUI", "CoreLiveMedia", "CoreRealtime", "DomainModels", "FeatureWallet", "FeatureGiftShop", "FeatureSponsor"]),
        .target(name: "FeatureCompetition", dependencies: ["CoreNetwork", "CoreUI", "CoreLiveMedia", "CoreRealtime", "DomainModels", "FeatureWallet", "FeatureGiftShop", "FeatureSponsor"]),
        ...
        .target(name: "FeatureWithdrawal", dependencies: ["CoreNetwork", "CoreUI", "DomainModels", "FeatureWallet"]),
