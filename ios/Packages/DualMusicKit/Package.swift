...
let package = Package(
    ...
    targets: [
        ...
        .target(name: "FeatureConcert", dependencies: ["CoreNetwork", "CoreUI", "DomainModels"]),
        .target(name: "FeatureCompetition", dependencies: ["CoreNetwork", "CoreUI", "CoreRealtime", "DomainModels"]),
