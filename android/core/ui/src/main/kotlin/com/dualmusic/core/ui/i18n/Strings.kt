...
val FrStrings = Strings(
    ...
    edit = "Modifier",
    changePasswordSectionHint = "Masqué — touchez pour changer votre mot de passe",
    quickActions = "Raccourcis",
    statArtistSpace = "Espace Artiste",
    statManagerSpace = "Espace Manager",
    statFanSpace = "Espace Fan",
    statVotesReceived = "Votes reçus",
    statDuelsWon = "Duels gagnés",
    statGiftsReceived = "Cadeaux reçus",
    statDuelsManaged = "Duels gérés",
    statActiveDuels = "En cours",
    statVotesCast = "Votes effectués",
    statGiftsSent = "Cadeaux envoyés",
    statTickets = "Billets achetés",
    statWinRate = "Taux de victoire",
    publicProfile = "Profil public",
    artisticProfile = "Profil artistique",
    ...
    deleteAccountGrace = "Un délai de 20 jours te permettra d'annuler avant la suppression définitive. Confirmer ?",
    accountDeletionScheduledOn = "⚠️ Ton compte sera supprimé le",
    deletionCanStillCancel = "Tu peux encore l'annuler.",
...
val EnStrings = Strings(
    ...
    edit = "Edit",
    changePasswordSectionHint = "Hidden — tap to change your password",
    quickActions = "Quick actions",
    statArtistSpace = "Artist space",
    statManagerSpace = "Manager space",
    statFanSpace = "Fan space",
    statVotesReceived = "Votes received",
    statDuelsWon = "Duels won",
    statGiftsReceived = "Gifts received",
    statDuelsManaged = "Duels managed",
    statActiveDuels = "Active",
    statVotesCast = "Votes cast",
    statGiftsSent = "Gifts sent",
    statTickets = "Tickets bought",
    statWinRate = "Win rate",
    publicProfile = "Public profile",
    artisticProfile = "Artist profile",
    ...
    deleteAccountGrace = "A 20-day grace period lets you cancel before permanent deletion. Confirm?",
    accountDeletionScheduledOn = "⚠️ Your account will be deleted on",
    deletionCanStillCancel = "You can still cancel.",
